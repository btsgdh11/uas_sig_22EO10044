...
<td>
<?php echo anchor('editkecamatan/'.$baris->kode_kecamatan,'<i class="fa-solid fa-pencil"></i>',['class'=>'btn btn-success']).' '.anchor('hapuskecamatan/'.$baris->kode_kecamatan,'<i class="fa-solid fa-trash-can"></i>',['class'=>'btn btn-danger']);?>
</td>
</tr>
<?php
}
